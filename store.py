...
class UserStore:
    ...
    def put_dir(self, dir: Dir):
        """Put a directory record into the store."""
        pass
    ...
    def get_dir(self, dir_id: str) -> Dir:
        """Returns a dir object to be found in the store.
        Errors out if not found.
        Will not resolve related objects from the store."""
        pass
